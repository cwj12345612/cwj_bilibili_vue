<!-- 分类卡片 -->
<template>
<div class="categorycard" :style="dynamicWH( {normal:245,max:380,min:240})">

<a class="img" href="#">
    <div class="categorylogo">
        <i class="colour dianshiju"></i>
        <span>电视剧</span>
    </div>
...
<div href="#" :title="title"  class="title"  :style="{...dynamicWH(
     {normal:229+16,max:356+24,min:224+16},
